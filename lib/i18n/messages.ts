...
export const vi = {
  ...
  'reminder.title': 'Lời nhắc mục tiêu',
  'reminder.body': 'Pill nhắc hiện ở góc trên phải màn hình. Mẫu bên dưới là hình thật của nó.',
  'reminder.sample': 'Còn “Làm 1 đề Nghe VSTEP” đang chờ bạn.',
  'reminder.interval': 'Nhắc mỗi',
  'reminder.custom': 'Tuỳ chọn',
  'reminder.customLabel': 'Số phút giữa hai lần nhắc',
  'reminder.minutes': 'phút',
  'reminder.off': 'Tắt lời nhắc',
  'reminder.on': 'Bật lời nhắc',
  'reminder.test': 'Thử ngay',
  'reminder.reset': 'Về mặc định',
  'reminder.saved': 'Đã lưu trên máy này',
  ...
  'tasks.signInTitle': 'Đăng nhập để giữ mục tiêu này',
  'tasks.signInBody':
    'Chưa đăng nhập thì mục tiêu chỉ nằm trên máy này. Dọn trình duyệt hoặc đổi máy là mất.',
  'tasks.signInCta': 'Đăng nhập',
  'tasks.signInSkip': 'Cứ thêm ở máy này',
  'tasks.deadlineTitle': 'Đặt hạn cho mục tiêu này',
  'tasks.deadlineDaily': 'Hằng ngày',
  'tasks.deadlineSet': 'Đặt hạn',
  'tasks.day': 'Ngày',
  'tasks.month': 'Tháng',
  'tasks.dateInvalid': 'Ngày không có thật. Năm thì không cần nhập.',
  'tasks.cancel': 'Huỷ',
  'progress.recommendTitle': 'Bắt đầu từ đâu',
  'progress.recommendLead':
    'Bạn chưa đánh dấu quan tâm đề nào. Bấm ngôi sao ở Kho đề để đề đó theo dõi tiến độ tại đây.',
  'progress.recommendCta': 'Xem đề',
  'progress.favEmpty': 'Chưa có đề quan tâm nào trong kỳ thi này.',
  'favorite.add': 'Đánh dấu quan tâm',
  'favorite.remove': 'Bỏ đánh dấu quan tâm',
...
export const en: Record<MessageKey, string> = {
  ...
  'reminder.title': 'Goal reminder',
  'reminder.body':
    'The reminder appears in the top right corner. The sample below is exactly how it looks.',
  'reminder.sample': 'Còn “Làm 1 đề Nghe VSTEP” đang chờ bạn.',
  'reminder.interval': 'Remind me every',
  'reminder.custom': 'Custom',
  'reminder.customLabel': 'Minutes between reminders',
  'reminder.minutes': 'minutes',
  'reminder.off': 'Turn reminders off',
  'reminder.on': 'Turn reminders on',
  'reminder.test': 'Show it now',
  'reminder.reset': 'Back to default',
  'reminder.saved': 'Saved on this device',
  ...
  'tasks.signInTitle': 'Sign in to keep this goal',
  'tasks.signInBody':
    'Without an account the goal stays on this device only. Clearing the browser or switching devices loses it.',
  'tasks.signInCta': 'Sign in',
  'tasks.signInSkip': 'Add it on this device',
  'tasks.deadlineTitle': 'Set a deadline for this goal',
  'tasks.deadlineDaily': 'Every day',
  'tasks.deadlineSet': 'Set deadline',
  'tasks.day': 'Day',
  'tasks.month': 'Month',
  'tasks.dateInvalid': 'That date does not exist. The year is not needed.',
  'tasks.cancel': 'Cancel',
  'progress.recommendTitle': 'Where to start',
  'progress.recommendLead':
    'You have not marked any paper as interesting yet. Select the star in the paper library and that paper will track its progress here.',
  'progress.recommendCta': 'Browse papers',
  'progress.favEmpty': 'No paper of interest in this exam yet.',
  'favorite.add': 'Mark as interesting',
  'favorite.remove': 'Remove from interesting',
...
export const de: Record<MessageKey, string> = {
  ...
  'reminder.title': 'Zielerinnerung',
  'reminder.body':
    'Die Erinnerung erscheint oben rechts. Das Muster unten zeigt sie genau so, wie sie aussieht.',
  'reminder.sample': 'Còn “Làm 1 đề Nghe VSTEP” đang chờ bạn.',
  'reminder.interval': 'Erinnere mich alle',
  'reminder.custom': 'Eigener Wert',
  'reminder.customLabel': 'Minuten zwischen den Erinnerungen',
  'reminder.minutes': 'Minuten',
  'reminder.off': 'Erinnerungen ausschalten',
  'reminder.on': 'Erinnerungen einschalten',
  'reminder.test': 'Jetzt anzeigen',
  'reminder.reset': 'Zurück zum Standard',
  'reminder.saved': 'Auf diesem Gerät gespeichert',
  ...
  'tasks.signInTitle': 'Melde dich an, um dieses Ziel zu behalten',
  'tasks.signInBody':
    'Ohne Konto bleibt das Ziel nur auf diesem Gerät. Wenn du den Browser leerst oder das Gerät wechselst, ist es weg.',
  'tasks.signInCta': 'Anmelden',
  'tasks.signInSkip': 'Auf diesem Gerät hinzufügen',
  'tasks.deadlineTitle': 'Setze eine Frist für dieses Ziel',
  'tasks.deadlineDaily': 'Täglich',
  'tasks.deadlineSet': 'Frist setzen',
  'tasks.day': 'Tag',
  'tasks.month': 'Monat',
  'tasks.dateInvalid': 'Dieses Datum gibt es nicht. Das Jahr brauchst du nicht.',
  'tasks.cancel': 'Abbrechen',
  'progress.recommendTitle': 'Wo du beginnen kannst',
  'progress.recommendLead':
    'Du hast noch keinen Testsatz als interessant markiert. Wähle den Stern in der Testsatz-Sammlung, dann verfolgt dieser Testsatz seinen Fortschritt hier.',
  'progress.recommendCta': 'Testsätze ansehen',
  'progress.favEmpty': 'In dieser Prüfung ist noch kein Testsatz als interessant markiert.',
  'favorite.add': 'Als interessant markieren',
  'favorite.remove': 'Markierung entfernen',
